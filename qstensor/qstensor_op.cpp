         ...
         int direction)
{
  ...
  for (size_t ii = 0; ii < mid_Q.size(); ii++) {
    ...
    // copy data from mU to qstensor U
    c_row = 0;
    for (size_t i = 0; i < l_qn_str_map[q].size(); i++) {
...
template void svd(qstensor<double>& A,vector<qtensor_index>& left, vector<qtensor_index>& right, qstensor<double>& U, qstensor<double>& V, vector<double>& S, int direction);
template void svd(qstensor< std::complex<double> >& A,vector<qtensor_index>& left, vector<qtensor_index>& right, qstensor< std::complex<double> >& U, qstensor< std::complex<double> >& V, vector<double>& S, int direction);
...
template void svd(qstensor<double>& A, vector<qtensor_index>& left, vector<qtensor_index>& right, qstensor<double>& U, qstensor<double>& V, vector<double>& S, int direction, double cutoff);
template void svd(qstensor< std::complex<double> >& A, vector<qtensor_index>& left, vector<qtensor_index>& right, qstensor< std::complex<double> >& U, qstensor< std::complex<double> >& V, vector<double>& S, int direction, double cutoff);*/
...
template void svd(qstensor<double>& A, vector<qtensor_index>& left, vector<qtensor_index>& right, qstensor<double>& U, qstensor<double>& V, vector<double>& S, int direction, double cutoff, long unsigned K);
template void svd(qstensor< std::complex<double> >& A, vector<qtensor_index>& left, vector<qtensor_index>& right, qstensor< std::complex<double> >& U, qstensor< std::complex<double> >& V, vector<double>& S, int direction, double cutoff, long unsigned K);*/
...
template void svd_bond(qstensor<double>& A_left, qstensor<double>& A_right, qtensor_index& mid, vector<double>& S, int direction);
template void svd_bond(qstensor< std::complex<double> >& A_left, qstensor< std::complex<double> >& A_right, qtensor_index& mid, vector<double>& S, int direction);*/
...
template void svd(qstensor<double>& A,vector<qtensor_index>& left, vector<qtensor_index>& right, qstensor<double>& U, qstensor<double>& V, qstensor<double>& S, int direction,double cutoff, unsigned K);

template<> void svd(qstensor< std::complex<double> >& A,vector<qtensor_index>& left, vector<qtensor_index>& right, qstensor< std::complex<double> >& U, qstensor< std::complex<double> >& V, qstensor<std::complex<double> >& S, int direction,double cutoff,unsigned K) { 
...
template void svd_bond(qstensor<double>& A_left, qstensor<double>& A_right, qtensor_index& mid, qstensor<double>& S, int direction, double cutoff, long unsigned K);
template void svd_bond(qstensor< std::complex<double> >& A_left, qstensor< std::complex<double> >& A_right, qtensor_index& mid, qstensor<std::complex<double> >& S, int direction, double cutoff, long unsigned K);
...
template void svd_bond(qstensor<double>& combined, qstensor<double>& A_left, qstensor<double>& A_right, qtensor_index& mid, qstensor<double>& S, int direction, double cutoff, long unsigned K);
template void svd_bond(qstensor< std::complex<double> >& combined, qstensor< std::complex<double> >& A_left, qstensor< std::complex<double> >& A_right, qtensor_index& mid, qstensor<std::complex<double> >& S, int direction, double cutoff, long unsigned K);
